...
SPECIAL_ALIASES: dict[str, tuple[str, ...]] = {
    ...
    "物资计算器": ("物资计算器", "物资计算", "材料计算", "材料计算器"),
    "建筑耗材统计": ("建筑耗材统计", "建家材料", "建筑材料", "造家材料", "基地材料"),
    "地基材料计算": ("地基材料计算", "地基材料", "地基耗材"),
    "房屋搭建模拟器": ("房屋搭建模拟器", "建家", "建家模拟", "房屋搭建", "基地搭建", "建房", "造家"),
    "防御工事配方表": ("防御工事配方表", "防御工事", "防御配方", "陷阱配方"),
    "全道具图鉴": ("全道具图鉴", "道具图鉴", "材料图鉴", "材料篇", "背包材料"),
    "武器配方": ("武器配方", "武器材料", "枪械配方"),
    "物资分布图": ("物资分布图", "物资分布", "物资地图", "物资点", "物资位置"),
    "资源采集点位": ("资源采集点位", "资源点", "资源位置", "采集点", "采集点位", "资源地图"),
    "载具刷新位置": ("载具刷新位置", "载具刷新点", "载具位置", "车刷新点"),
    "科技树查询": ("科技树查询", "科技树", "科技路线"),
    "饱食度计算器": ("饱食度计算器", "饱食度", "食物消耗"),
    "口渴值计算器": ("口渴值计算器", "口渴值", "饮水消耗"),
    "装备耐久计算": ("装备耐久计算", "装备耐久", "耐久计算", "耐久消耗"),
    "抄家防御模拟": ("抄家防御模拟", "抄家", "防抄家", "抄家防御", "防抄"),
    "基地物资储量统计": ("基地物资储量统计", "基地物资", "物资储量", "仓库物资"),
}
